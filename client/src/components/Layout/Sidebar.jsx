...
export default function Sidebar({ items = [], user, onLogout, label = "Workspace" }) {
  return (
    <aside className="sticky top-0 flex h-screen w-60 flex-col bg-linear-to-b from-indigo-500 to-indigo-700 px-4 py-6 text-white">
      ...
      <p className="px-3 pb-2 text-[10px] font-semibold uppercase tracking-widest text-white/55">
        {label}
      </p>
